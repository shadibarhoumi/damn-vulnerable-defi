...
describe('[Challenge] The rewarder', function () {
  ...
  it('Exploit', async function () {
    ...
    const ExploitFactory = await ethers.getContractFactory('RewarderExploit', deployer)
    ...
    // console.log(this.liquidityToken.balanceOf(this.rewarderPool.address))
  })
  ...
  after(async function () {
    ...
    // let atrewards = await this.rewardToken.balanceOf(attacker.address)
    // console.log('attacker rewards', atrewards.toNumber())
    ...
    console.log('attacker rewards', rewards)
