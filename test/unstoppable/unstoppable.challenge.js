...
describe('[Challenge] Unstoppable', function () {
  ...
  before(async function () {
    ...
    const balance = await this.token.balanceOf(deployer.address)

    // deployer approves pool
    await this.token.approve(this.pool.address, TOKENS_IN_POOL)
    // deployer deposits tokens
  ...
  it('Exploit', async function () {
    ...
    receiver = await ReceiverContractFactory.deploy(this.pool.address)
